...
def create_app_ui():
    ...
    html.H1(id='Main_title', children = "Sentiment Analysis with Insights",style={'color':colors['text'],'text-align':'center'}),
    html.Hr(style={'background-color':'pink'}),
    html.H2(children = "Pie Chart",style = {'text-align':'center','text-decoration':'underline','color':'yellow'}),
    html.P([html.Img(src=app.get_asset_url('sentiment.png'),style={'width':'700px','height':'400px'})],style={'text-align':'center'}),
    html.Hr(style={'background-color':'pink'}),
    html.H2(children = "WordCloud",style = {'text-align':'center','color':'yellow','text-decoration':'underline'}),
    html.P([html.Img(src=app.get_asset_url('wordCloud.png'),style={'width':'700px','height':'400px'})],style={'text-align':'center'}),
    html.Hr(style={'background-color':'pink'}),
    html.H2(children = "Select a Review",style = {'text-align':'center','color':'white','text-decoration':'underline'}),
    dcc.Dropdown(
                id='Chart_Dropdown', 
                  options=chart_dropdown_values,
                  placeholder = 'Select a Review',style={'font-size':'22px','height':'70px'}
                    ),
    html.H1(children = 'Missing',id='sentiment1',style={'color':'yellow','text-align':'center'}),
    html.Hr(style={'background-color':'pink'}),
    html.H2(children = "Find Sentiment of Your Review",style = {'color':'yellow','text-align':'center','text-decoration':'underline'}),
    dcc.Textarea(
        id = 'textarea_review',
    ...
    html.H1(children = 'Missing', id='result',style={'color':'yellow','text-align':'center'})
