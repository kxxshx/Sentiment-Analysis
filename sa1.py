...
def create_app_ui():
    ...
    main_layout = dbc.Container(
        dbc.Jumbotron(
                [
                    html.Div(style={'backgroundColor':'#93FFE8'},children=[
                    html.H1(id = 'heading', children = project_name, className = 'display-3 mb-4',style={'color':'#43302E'}),
...
def update_app_ui(n_clicks, textarea):
    ...
    if (result_list[0] == 0 ):
        return dbc.Alert("Negative", color="#F6358A")
    elif (result_list[0] == 1 ):
        return dbc.Alert("Positive", color="#38ACEC")
    else:
        return dbc.Alert("Unknown", color="#0909FF")
